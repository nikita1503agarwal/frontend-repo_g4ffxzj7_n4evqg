...
export default function Rooms() {
  ...
  const [form, setForm] = useState({ name: '', capacity: 1, gender: 'mixed', type: 'dorm', amenities: '' })
  ...
  const createRoom = async (e) => {
    ...
    setForm({ name: '', capacity: 1, gender: 'mixed', type: 'dorm', amenities: '' })
    setLoading(false)
    fetchRooms()
  }
  ...
  return (
    <div className="bg-slate-800/50 border border-blue-500/20 rounded-xl p-5">
      ...
      <form onSubmit={createRoom} className="grid md:grid-cols-5 gap-3 mb-4">
        ...
        <button disabled={loading} className="md:col-span-3 bg-blue-600 hover:bg-blue-700 text-white rounded px-4 py-2 flex items-center justify-center gap-2">
